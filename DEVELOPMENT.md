...
```bash
git clone https://github.com/dsebastien/obsidian-hidden-folders-access.git
cd obsidian-hidden-folders-access
```
...
If you prefer not to use the environment variable, manually copy these files to `<YourVault>/.obsidian/plugins/hidden-folders-access/`:
...
- Check that files exist in `<vault>/.obsidian/plugins/hidden-folders-access/`
- Restart Obsidian
