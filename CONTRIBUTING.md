...
2. Clone your fork locally:
    ```bash
    git clone https://github.com/YOUR_USERNAME/obsidian-hidden-folders-access.git
    cd obsidian-hidden-folders-access
    ```
3. Add the upstream repository as a remote:
    ```bash
    git remote add upstream https://github.com/dsebastien/obsidian-hidden-folders-access.git
    ```
